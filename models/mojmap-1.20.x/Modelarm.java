...
public class Modelarm<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "arm"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(24, 16)
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 32)
						.addBox(-3.0F, 10.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition cube_r1 = RightArm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(40, 28).addBox(-4.0F, -4.6F, -0.5F, 4.0F, 0.0F, 1.0F,
		...
		PartDefinition cube_r5 = RightArm.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(40, 30)
						.addBox(-1.0F, 2.3F, 6.0F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 29)
						.addBox(-1.0F, -2.3F, 6.0F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 36)
						.addBox(-1.0F, -2.0F, 6.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
