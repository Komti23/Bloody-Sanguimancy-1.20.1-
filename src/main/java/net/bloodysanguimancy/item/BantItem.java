...
public abstract class BantItem extends ArmorItem {
	public BantItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends BantItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "bloodysanguimancy:textures/entities/texture.png";
		}
	}
}
