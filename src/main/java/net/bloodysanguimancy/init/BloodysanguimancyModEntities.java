...
import net.bloodysanguimancy.entity.ShurikenEntity;
...
public class BloodysanguimancyModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, BloodysanguimancyMod.MODID);
